...
describe('AuthService', () => {
  ...
  let userService: { findByEmail: jest.Mock; findByEmailWithPassword: jest.Mock; create: jest.Mock; findById: jest.Mock };
  ...
  describe('register', () => {
    it('rejects duplicate email', async () => {
      userService.findByEmail.mockResolvedValue({ id: 1, email: 'dup@test.com' });
